...
## [16.0.1](https://github.com/bluebluesaku/revm/compare/revm-context-interface-v16.0.0...revm-context-interface-v16.0.1) - 2026-03-12

### Fixed

- expose JournalLoadError from load_account_mut_skip_cold_load ([#3477](https://github.com/bluebluesaku/revm/pull/3477))

### Other

- clarify PrecompileError::Fatal vs Other and EVMError::Custom ([#3496](https://github.com/bluebluesaku/revm/pull/3496))
