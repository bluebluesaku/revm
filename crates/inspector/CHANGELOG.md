...
## [17.0.1](https://github.com/bluebluesaku/revm/compare/revm-inspector-v17.0.0...revm-inspector-v17.0.1) - 2026-03-12

### Fixed

- ensure both inspectors receive paired call/create events in tuple impl ([#3473](https://github.com/bluebluesaku/revm/pull/3473))
