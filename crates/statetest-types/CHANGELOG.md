...
## [16.0.1](https://github.com/bluebluesaku/revm/compare/revm-statetest-types-v16.0.0...revm-statetest-types-v16.0.1) - 2026-03-12

### Other

- remove unused bytecode dependency from revm-statetest-types ([#3485](https://github.com/bluebluesaku/revm/pull/3485))
