...
## [9.0.1](https://github.com/bluebluesaku/revm/compare/revm-bytecode-v9.0.0...revm-bytecode-v9.0.1) - 2026-03-12

### Fixed

- make Bytecode Ord consistent with PartialEq and Hash ([#3479](https://github.com/bluebluesaku/revm/pull/3479))
